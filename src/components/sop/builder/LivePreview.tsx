...
export function LivePreview({
  ...
  return (
    ...
    >
      ...
      {/* We need min-w-max so the container expands when the content is scaled from top-left */}
      <div className="min-h-full min-w-max w-full p-4 md:py-8 md:px-4 flex flex-col items-center print:p-0 print:m-0 relative z-10">
        ...
        {/* 
          Using transform-origin top left allows the element to scale right and down.
          To ensure it stays centered when smaller than the screen, we wrap it in a flex container.
          To allow scrolling when larger, we adjust width/height padding.
        */}
        <div
