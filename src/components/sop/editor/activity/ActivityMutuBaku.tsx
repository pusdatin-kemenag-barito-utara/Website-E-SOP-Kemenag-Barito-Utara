...
export function ActivityMutuBaku({ act, onUpdate }: ActivityMutuBakuProps) {
  return (
    <div className="w-full lg:w-[280px] space-y-3">
      ...
      <div className="p-3 md:p-4 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 space-y-3 sm:space-y-4 shadow-sm">
        <div className="space-y-1.5">
          ...
          <Textarea
            ...
            className="min-h-[40px] sm:min-h-[50px] max-h-[80px] sm:max-h-none overflow-y-auto text-sm bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 rounded-xl focus-visible:ring-[#015C3A] focus-visible:border-[#015C3A]"
          />
        </div>
        <div className="space-y-1.5">
          <span className="text-xs font-bold text-slate-700 dark:text-slate-200 ml-0.5">
          ...
          <Input
            ...
            className="h-9 sm:h-10 text-sm bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 rounded-xl focus-visible:ring-[#015C3A] focus-visible:border-[#015C3A]"
          />
        </div>
        <div className="space-y-1.5">
          <span className="text-xs font-bold text-slate-700 dark:text-slate-200 ml-0.5">
