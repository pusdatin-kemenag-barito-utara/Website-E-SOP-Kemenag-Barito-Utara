  ...
  return (
    <div className="relative group">
      <Textarea
        ...
        className={cn(
          "min-h-[80px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-semibold text-slate-800 dark:text-slate-100 leading-relaxed resize-none transition-all focus:border-[#015C3A] focus:ring-1 focus:ring-[#015C3A] pr-10 px-4 py-3",
          className,
        )}
      />
      <button
